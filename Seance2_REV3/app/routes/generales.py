...
@app.route("/langues")
def langues():
    donnees = [ {"nom": "France", "langues": ["Français"]}, {"nom": "Suisse", "langues": ["Français", "Allemand", "Italien", "Romanche"]}, {"nom": "Inde", "langues": ["Hindi", "Anglais"]}, {"nom": "Afrique du Sud", "langues": ["Zulu", "Xhosa", "Afrikaans", "Anglais", "Sesotho"]} ]
    return render_template("pages/langues.html", donnees=donnees)
...
def parcsEoliens ():
    ...
    return render_template("pages/parcs_eoliens.html", donnees=donnees)
# Je n'ai pas eu besoin du package json car les données sont déjà fournies dans un format de liste de dictionnaires python
