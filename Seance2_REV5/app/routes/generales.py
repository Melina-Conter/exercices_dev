...
@app.route("/parc/<idparc>")
def infos_parc (idparc):
    donnees = [
      {
         "datasetid":"installations-de-production-eolien-par-commune",
         "recordid":"5800903acd0e5e4975490ae016641ed745aa6705",
    ...
    donnees_parc = next((region for region in donnees if region["recordid"] == idparc), None)
    
    return render_template("pages/parc.html", donnees_parc=donnees_parc)
